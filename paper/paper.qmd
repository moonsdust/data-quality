...
![Weight of the selected dimensions for data quality assessment and the metrics for each dimension](../other/images/weight.png)
...
In @sec-results, we looked at the data quality of 39,580 datasets on the Open Data Toronto 
